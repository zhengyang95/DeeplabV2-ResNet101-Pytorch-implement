...
sys.path.append('/utilisateurs/lyuzheng/DeepL/2024_11_submit/DLV2_ResNet_101_Segmentation')
...
def get_argparser():
    ...
    parser.add_argument("--config_path", type=str,
                        default='/utilisateurs/lyuzheng/DeepL/2024_11_submit/DLV2_ResNet_101_Segmentation/configs/voc_seg.yaml',
    ...
    parser.add_argument("--output_dir", type=str,
                        default='/media/data/lyuzheng/Result/2024/08/0827_1_dlv2_gt/',
                        help="output directory")
    parser.add_argument("--log_dir", type=str, default='/media/data/lyuzheng/Result/2024/08/0827_1_dlv2_gt/', help="training log path")
